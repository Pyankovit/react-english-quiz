...
export default class QuizCreator extends Component {
  ...
  handleAddNewQuestion = () => {
    ...
    const {question, questionText, option1, option2, option3, option4} = this.state.formControls
  ...
  handleFinishQuiz = async () => {
    try {
      await axios.post('https://react-quiz-b3041.firebaseio.com/quizes.json', this.state.quiz)
